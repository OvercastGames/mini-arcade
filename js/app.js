...
let kenneyThick = new FontFace('kenney-thick', 'url(mini-arcade/img/kenney-thick.ttf)');
document.fonts.add(kenneyThick);
let kenney = new FontFace('kenney', 'url(mini-arcade/img/kenney.ttf)');
...
let upImg = new Image();
upImg.src = 'mini-arcade/img/joystickup.png';
let downImg = new Image();
downImg.src = 'mini-arcade/img/joystickdown.png';
let leftImg = new Image();
leftImg.src = 'mini-arcade/img/joystickleft.png';
let rightImg = new Image();
rightImg.src = 'mini-arcade/img/joystickright.png';
let normalImg = new Image();
normalImg.src = 'mini-arcade/img/joysticknormal.png';
  ...
  switch (state) {
    ...
    case 'gameOver':
      if (isNewHighScore(snakeGame.score)) {
        ...
        state = 'highScore';
        let sound = new Audio('mini-arcade/audio/new-highscore.ogg');
        sound.volume = 0.30;
        setTimeout(function () {
          sound.play();
        }, 1000);
